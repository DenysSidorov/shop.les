            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <img  class="imageUpdateBorder" src="<?php echo Product::getImage($product['id']); ?>" width="200" alt="" />
                        <input class="updateImageInput" type="file" name="image" placeholder="" value="<?php echo $product['image']; ?>">
